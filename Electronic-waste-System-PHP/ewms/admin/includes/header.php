...
$ret1=mysqli_query($con,"select tblproduct.ID as pid,tblproduct.ProductId,tbluser.FullName from tblproduct
 join tbluser  on tbluser.ID=tblproduct.UserID 
 where   (tblproduct.Status is null || tblproduct.Status='')");
...
<?php } }  else {?>
  <li>  No New Request Received</li>
        <?php } ?>
                ...
                <li>
                    <a href="all-products.php">See all Request</a>
                </li>
            </ul>
        </li>
